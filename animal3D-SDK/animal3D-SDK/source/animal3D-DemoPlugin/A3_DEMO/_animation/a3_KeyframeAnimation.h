...
//-----------------------------------------------------------------------------
	...
	union a3_Sample
	{
		...
		a3vec2 sample; // A point on a graph... OR
		struct { a3real time_t, value_x; }; // A structure where you have named axes.
	};
	...
	struct a3_Keyframe
	{
		...
		// data represents sprite cell in this program. In others it might represent something else. 
		//a3ui32 value;

		a3_Sample keySample; // value of the data, associated with the data.

		// Think in Maya, the sample is the diamond, and the little triangle boys are the handles.
		// The one on the right is the keyHandle change, (after), the other one is the reverseHandle, and we want to know the difference.
		// Interpolations are in the vector file.
		union {
