...
void a3demo_input_main(a3_DemoState *demoState, a3f64 dt)
{
	...
	else
	{
		...
		if (a3keyboardIsPressed(demoState->keyboard, a3key_L))
			demoState->testSpriteSheetClipController->playDirection = 1;
		if (a3keyboardIsPressed(demoState->keyboard, a3key_colon))
			demoState->testSpriteSheetClipController->playDirection = 0;
		if (a3keyboardIsPressed(demoState->keyboard, a3key_apostrophe))
			demoState->testSpriteSheetClipController->playDirection = -1;
